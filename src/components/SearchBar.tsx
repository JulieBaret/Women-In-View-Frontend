    ...
    return (
        <form onSubmit={onSubmit}>
            <div className="relative">
                ...
                <input type="search" id="default-search" className="block w-64 h-10 px-4 text-sm text-light border border-transparent rounded-full bg-gray-50 bg-opacity-30 focus:ring-primary focus:border-primary placeholder-light" placeholder={placeholder} onChange={onChange} value={value} />
