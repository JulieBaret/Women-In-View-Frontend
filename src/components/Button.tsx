...
const Button = ({type = "submit", value, variant, disabled, onClick}: Props) => {
    ...
    return (
        <input type={type} className={`disabled:opacity-50 focus:outline-none cursor-pointer text-white ${variantToClasses[variant]} focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mb-2`}
