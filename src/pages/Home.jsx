        ...
        <div className='w-5/6 flex flex-col gap-6 p-20 self-center'>
            <form>
                <div className="relative">
                    ...
                    <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-4 py-2">Search</button>
                </div>
            </form>
        </div>
    );
